...
class Database:
    ...
    def store_gaming_credentials(self, username, twitch, discord, steam):
        ...
        try:
            ...
            encrypted_twitch = self.encrypt(twitch) if twitch.split(':')[0] and twitch.split(':')[1] else None
            encrypted_discord = self.encrypt(discord) if discord.split(':')[0] and discord.split(':')[1] else None
            encrypted_steam = self.encrypt(steam) if steam.split(':')[0] and steam.split(':')[1] else None
